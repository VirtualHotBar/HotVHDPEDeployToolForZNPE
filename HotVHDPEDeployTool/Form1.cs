...
namespace HotVHDPEDeployTool
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            static string runCmd(string name1)
            {
            ...
            static string setVHDX(string path,int size,string type)
            {
            ...
            setVHDX(textBox2.Text+":\\windows.vhdx", Convert.ToInt32(textBox1.Text)*1024, "expandable");//type=expandable:动态大小 fixed:固定大小
